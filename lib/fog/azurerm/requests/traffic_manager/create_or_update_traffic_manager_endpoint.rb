    ...
    class AzureRM
      ...
      class Real
        ...
        def get_endpoint_object(target_resource_id, target, weight, priority, endpoint_location, min_child_endpoints)
          endpoint = Azure::TrafficManager::Profiles::Latest::Mgmt::Models::Endpoint.new
      ...
      class Mock
        def create_or_update_traffic_manager_endpoint(*)
          ...
          endpoint_mapper = Azure::TrafficManager::Profiles::Latest::Mgmt::Models::Endpoint.mapper
