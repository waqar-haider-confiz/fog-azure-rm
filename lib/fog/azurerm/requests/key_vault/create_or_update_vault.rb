    ...
    class AzureRM
      ...
      class Real
        ...
        def get_vault_param_object(vault_hash)
          vault_param = Azure::KeyVault::Profiles::Latest::Mgmt::Models::VaultCreateOrUpdateParameters.new
        ...
        def get_vault_properties_object(vault_hash)
          vault_properties = Azure::KeyVault::Profiles::Latest::Mgmt::Models::VaultProperties.new
        ...
        def get_sku_object(vault_hash)
          sku = Azure::KeyVault::Profiles::Latest::Mgmt::Models::Sku.new
        ...
        def get_access_policy_entry_object(access_policy_hash)
          access_policy_entry = Azure::KeyVault::Profiles::Latest::Mgmt::Models::AccessPolicyEntry.new
        ...
        def get_permission_object(permission_hash)
          permission = Azure::KeyVault::Profiles::Latest::Mgmt::Models::Permissions.new
      ...
      class Mock
        def create_or_update_vault(*)
          ...
          vault_mapper = Azure::KeyVault::Profiles::Latest::Mgmt::Models::Vault.mapper
