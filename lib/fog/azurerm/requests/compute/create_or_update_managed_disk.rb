    ...
    class AzureRM
      ...
      class Real
        def create_or_update_managed_disk(managed_disk_params)
          ...
          puts "what is disssssk #{disk.inspect}"
          begin
        ...
        def get_managed_disk_object(managed_disk_params)
          ...
          sku = Azure::Compute::Profiles::Latest::Mgmt::Models::DiskSku.new
          sku.name = managed_disk_params[:sku][:name]
          puts "whatcha got? #{sku.inspect}"
          managed_disk.sku = sku
